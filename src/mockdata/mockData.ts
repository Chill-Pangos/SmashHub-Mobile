...
export const mockTournaments: Tournament[] = [
  {
    ...
    description:
      "Giải đấu cầu lông hàng đầu Việt Nam với sự tham gia của các VĐV xuất sắc nhất",
  ...
  {
    id: "t2",
    name: "Giải Cầu Lông Mở Rộng TP.HCM",
    description:
      "Giải đấu cầu lông chuyên nghiệp cho các VĐV trong và ngoài nước",
  ...
  {
    id: "t4",
    name: "Giải Cầu Lông Các Câu Lạc Bộ",
    description: "Giải đấu giao hữu giữa các câu lạc bộ cầu lông",
    format: "Đơn Nam, Đơn Nữ, Đôi Nam Nữ",
...
export const mockMatches: Match[] = [
  {
    ...
    scheduledTime: "2025-01-16T09:00:00Z",
    startTime: "2025-01-16T09:05:00Z",
    courtNumber: "Sân 1",
    status: "live",
  ...
  },
  {
    ...
    scheduledTime: "2025-01-16T10:30:00Z",
    courtNumber: "Sân 2",
    status: "scheduled",
  ...
  },
  {
    ...
    startTime: "2025-01-15T14:02:00Z",
  ...
  },
  {
    id: "m4",
    tournamentId: "t2",
    tournamentName: "Giải Cầu Lông Mở Rộng TP.HCM",
    roundName: "Vòng bảng",
    ...
    awayPlayerAvatar: "https://i.pravatar.cc/150?img=13",
    scheduledTime: "2025-02-02T09:00:00Z",
    courtNumber: "Sân 3",
    status: "scheduled",
    format: MatchFormat.SINGLES,
  },
...
export const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: "Bạn đã đăng ký tham gia Giải Cầu Lông Mở Rộng TP.HCM thành công",
    isRead: true,
    relatedId: "t2",
...
export const mockNews: News[] = [
  {
    ...
    content:
      "Giải đấu cầu lông Vô Địch Quốc Gia 2025 đã chính thức khai mạc sáng nay tại Nhà thi đấu Quần Ngựa, Hà Nội. Đây là sự kiện thể thao lớn nhất trong năm với sự tham gia của hơn 120 VĐV xuất sắc nhất đến từ 15 tỉnh thành trên cả nước. Giải đấu diễn ra trong 10 ngày với 5 nội dung thi đấu chính...",
    coverImage:
    ...
    views: 1523,
    likes: 245,
    tags: ["giải đấu", "khai mạc", "cầu lông"],
  },
  {
    id: "news2",
